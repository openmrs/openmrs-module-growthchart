var moduleResourceRootPath = "../ms/uiframework/resource/growthchart";
...
function generate_ChartJS_dataset(labelHackCode, dataValues) {
	return {
		...
		spanGaps : true,
		pointBackgroundColor:  ((labelHackCode == "Patient") ? growthChartCurveColors[labelHackCode]:""),
		pointRadius: ((labelHackCode == "Patient") ? 4.5 : 3),
	};
}

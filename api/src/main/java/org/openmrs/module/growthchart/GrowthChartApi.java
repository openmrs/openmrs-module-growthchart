...
public class GrowthChartApi {
	...
	private Date getObservationDate(Obs obs) {
		return obs == null ? null : (obs.getObsDatetime() != null ? obs.getObsDatetime()
	...
	private Set<Obs> getHeadCircumferenceConceptObsForAPatient(Patient patient) {
		...
		return new HashSet<Obs>(headCircumferenceConcept != null ? Context.getObsService()
		        .getObservationsByPersonAndConcept(patient.getPerson(), headCircumferenceConcept) : null);
	}
